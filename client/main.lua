...
Menu_vehicule = RageUI.CreateSubMenu(Menu_Give, "Liste Véhicule", "Spawn Vehicule")
        ...
        CreateThread(function()
            while menu_Isopen do 
                ...
                RageUI.IsVisible(Menu_vehicule, function()
                    ...
                    RageUI.Checkbox("Être tp dans le vehicule", nil, checkbox12, {}, { 
                    ...
                    RageUI.Button("Poser blips", nil, {RightLabel = "→→"}, true, {
                        onSelected = function()
                            ...
                            if UpdateOnscreenKeyboard() ~= 2 then
                                ...
                                SetBlipSprite(blip, tonumber(numero_blips)) 
                                ...
                                if UpdateOnscreenKeyboard() ~= 2 then
                                    ...
                                    AddTextComponentString(text_blips) 
